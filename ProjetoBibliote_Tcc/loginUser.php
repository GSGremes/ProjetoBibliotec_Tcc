...
<<<<<<< HEAD
                    <img src="./assets/logoBlack.png" width="75%">
=======
...
>>>>>>> aaab1c9c3b8a61e398e4e26c9fcc75d189fd999e
                ...
                <form class="row g-3 justify-content-end" method="POST">
                    <div class="col-auto">
                        ...
                        <input type="text" size="40px" class="form-control" name="email" autofocus
                            placeholder="user@etec.sp.gov.br">
                    </div>
                    <div class="col-auto">
                        <label for="inputPassword2" class="visually">Senha</label>
                        <input type="password" size="40px" class="form-control" name="senha" placeholder="*********">
    ...
    <main>
        ...
        <div class="container" style="margin-top:10rem">
            <div class="row">
                ...
                <div class="col-sm">
                    <h3>Entre em nossa <br> comunidade</h3>
